...
Route::put('/bricklink/inventories/{inventoryId}', [ApiController::class, 'updateBricklinkInventoryItem'])
    ->where('inventoryId', '[0-9]+|[a-zA-Z0-9_-]+');
...
Route::get('/inventories-categories', [ApiController::class, 'uniqueInventoryCategories']);
